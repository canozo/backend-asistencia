...
CREATE TABLE IF NOT EXISTS `attendance_x_student` (
  ...
  `capture_key` VARCHAR(50) COMMENT 'Si se marco con una camara, el capture key que se utilizo, en otras palabras, el rostro de la persona que se utilizo para marcar al estudiante, ej: 20200419183217282336.jpg para el key captures/20200419183217282336.jpg',
